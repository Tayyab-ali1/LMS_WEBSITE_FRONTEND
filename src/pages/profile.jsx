    ...
    <div className="min-h-screen bg-gray-100 px-4 py-10 flex items-center justify-center">
      <div className="bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative">
        ...
        <div className="flex flex-col items-center text-center ">
          ...
          <p className="text-sm text-gray-500">{userData?.user?.role || "User"}</p>
        </div>

        <div className="mt-6 space-y-4 flex flex-col items-start gap-1">
          <div>
          ...
          <div className="text-sm flex items-center justify-start gap-1">
            ...
            <span className='overflow-hidden'>{userData?.user?.description || "No bio added"}</span>
          </div>
          <div className="text-sm flex items-center justify-start gap-1">
