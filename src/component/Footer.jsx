    ...
    <div className='bg-black text-gray-300 py-10 px-6'>
        ...
        gap-[40px] lg:gap-[150px] flex-col lg:flex-row'>
            ...
            <div className='lg:w-[40%] md:w-[50%] w-[100%]'>
                ...
                <h2 className='text-xl font-bold text-white mb-3 '>Learning Hub</h2>
                <p className='text-sm'>AI-powerd learning platform to help you grow smarter. Learn anything,anytime,anywhere.</p>
            </div>
