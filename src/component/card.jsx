...
console.log("Average Rating:", avgRating);
  ...
  return (
    <div
      className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md
      hover:shadow-lg transition-all duration-300 border border-gray-300'
      onClick={() => navigate(`/viewcourse/${id}`)}  // ✅ fixed here
    >
      <img src={thumbnail} alt={title} className='w-full h-48 object-cover' />

      <div className='p-5 space-y-2'>
        <h2 className='text-large font-semibold text-gray-900'>{title}</h2>
