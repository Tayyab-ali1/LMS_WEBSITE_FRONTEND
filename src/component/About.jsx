...
import video from '../assets/video.jpg.mp4'
...
{/* for about infp */}
      <div className='lg:w-[50%] md:w-[70%] w-[100%] h-[100%] flex items-start justify-center flex-col px-[35px] md:px-[80px]'>
        <div className='flex text-[20px] items-center justify-center gap-[20px]'>About Us
             <TfiLayoutLineSolid className='w-[40px] h-[40px] ' /></div>
             ...
             <div className='text-[15px]'>We provide a modern Learning Management System to simplify online education, track progress,
                 and enhance student-instructor collaboration efficiently. </div>
                 <div className='w-[100%] lg:w-[60%]'>
                    <div className='flex items-center justify-between mt-[40px]'>
                        <div className='flex items-center gap-[10px]'> 
                            <BsFillPatchCheckFill className='w-[20px] h-[20px]'/>Simplified Learning</div>
                              <div className='flex items-center gap-[10px]'> 
                            <BsFillPatchCheckFill className='w-[20px] h-[20px]'/>Expert Trainers</div>
                          </div>
                             <div className='flex items-center justify-between mt-[40px]'> 
                              <div className='flex items-center gap-[10px]'> 
                            <BsFillPatchCheckFill className='w-[20px] h-[20px]'/>Big Experience</div>
                              <div className='flex items-center gap-[10px]'> 
                            <BsFillPatchCheckFill className='w-[20px] h-[20px]'/>LifeTime Access</div> 
                    </div>
