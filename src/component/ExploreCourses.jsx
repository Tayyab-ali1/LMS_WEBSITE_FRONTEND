...
function ExploreCourses() {
  ...
  return (
    <div className="w-[100vw] min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row 
    items-center justify-center  gap-4 px-[30px] ">
        {/* left-top div */}
        <div className="w-[100%] lg:w-[350px] lg:h-[100%]  h-[400px] 
        flex flex-col items-start  justify-center gap-2 md:px-[40px]
        px-[20px] ">

            <span className="text-[32px] font-semibold">Explore</span>
           <span  className="text-[32px] font-semibold">Our Courses</span>
           <p className="text-[14px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
             totam, voluptatibus facere quisquam architecto adipisci fuga dolore assumenda
             laboriosam recusandae aliquam quas cupiditate voluptatum, dolorem vero facilis </p>
        ...
        flex items-center justify-center lg:gap-[60px] gap-[50px] flex-wrap mb-[50px] lg:mb-[0px] '>
         ...
         Data Science 
               ...
               <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center '>
            <div className='w-[100px] h-[90px] bg-[#fbd9fb] rounded-lg flex items-center justify-center'>
                <BsClipboard2Data  className='w-[50px] h-[50px] text-[#6d6c6c]'/>
            </div>
          Data Analytics 
            </div> 
