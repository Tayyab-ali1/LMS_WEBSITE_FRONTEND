    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10'>
      ...
      <form className='space-y-5' onSubmit={(e)=>e.preventDefault()}>
        <div>
          ...
          <input type="text" id='title' placeholder='Enter Course title' className='w-full border border-gray-300 rounded-md px-4
        ...
        <select  id="cat" className='w-full border border-gray-300
         rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[black]'
          ...
          <option value="Data Analytices">Data Analytices</option>
        ...
        <button className='w-full bg-[black] text-white py-2 px-4 rounded-md active:bg-[#3a3a3a] transition'
        disabled={loading} onClick={handleCreateCourse}>
