    ...
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
        <div className='w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6 '>
            ...
            <button className='mt-2 px-4 py-2 bg-red-600 text-white
             rounded-md hover:bg-red-700 transition-all text-sm' disabled={loading1} onClick={removeLecture}>
             ...
             <div className='space-y-4 '>
                <div>
                    ...
                    <input type="text" className='w-full p-3 border border-gray-300 
                ...
                <div>
                    ...
                    file:text-sm file:bg-gray-700 file:text-[white] hover:file:bg-gray-500 ' required 
             ...
             <div className='pt-4 '>
                ...
                text-sm font-medium hover:bg-gray-700 transition' disabled={loading} onClick={handleEditLecture}>
